...
void main() {
  group('GetPacker', () {
    ...
    group('String', () {
      ...
      test('throws BigDataException for string larger than 0xFFFFFFFF', () {
        final str = 'a' * (0xFFFFFFFF + 1);
        expect(() => GetPacker.pack(str), throwsA(isA<BigDataException>()));
      });
    ...
    group('Binary', () {
      ...
      test('throws BigDataException for binary larger than 0xFFFFFFFF', () {
        final data = Uint8List(0xFFFFFFFF + 1);
        expect(() => GetPacker.pack(data), throwsA(isA<BigDataException>()));
      });
    });
    ...
    group('List', () {
      ...
      test('encodes list with length 16777216 (16MB)', () {
        final list = List.generate(16777216, (index) => index);
        expect(GetPacker.unpack(GetPacker.pack(list)), equals(list));
      });

      test('throws BigDataException for list larger than 0xFFFFFFFF', () {
